...
<body>
    <p><img src="./images/MAMP-PRO-Logo.png" id="logo" alt="MAMP PRO Logo" width="250" height="49" /></p>
...
<?php if ($str_language == 'de'): ?>
    ...
    <p class="text" id="footnote_1"><small><sup>1</sup> Dateien: <samp>index.php</samp> und <samp>images/MAMP-PRO-Logo.png</samp></small></p>
    <hr />
...
<?php elseif ($str_language == 'en'): ?>
    ...
    <p class="text" id="footnote_1"><small><sup>1</sup> Files: <samp>index.php</samp> and <samp>images/MAMP-PRO-Logo.png</samp></small></p>
    <hr />
